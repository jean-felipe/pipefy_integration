...
#   Mayor.create(name: 'Emanuel', city: cities.first)
    ...
    Card.create(title: "Correr 3 horas", current_phase_id: @phase.id, phase_id: @phase.id)
    Card.create(title: "Correr 3 horas", current_phase_id: @phase.id, phase_id: @phase.id)
    Card.create(title: "Correr 3 horas", current_phase_id: @phase4.id, phase_id: @phase4.id)
    Card.create(title: "Correr 3 horas", current_phase_id: @phase7.id, phase_id: @phase4.id)
    Card.create(title: "Correr 3 horas", current_phase_id: @phase7.id, phase_id: @phase7.id)
